...
import com.xiaonan.pojo.User;
import com.xiaonan.utils.JsonUtils;
...
public class UserController {
    ...
    //  @ResponseBody，将服务器端返回的对象转换为json对象
    //  @RequestBody
    @ResponseBody
    ...
    //  我们需要设置一下他的编码格式为utf-8,以及它的返回的类型；
    ...
    public String json3() throws JsonProcessingException {
        ...
        User user1 = new User("小南1号",1,"男");
        User user2 = new User("小南2号",1,"男");
        User user3 = new User("小南3号",1,"男");
        User user4 = new User("小南4号",1,"男");
        list.add(user1);
        list.add(user2);
        list.add(user3);
        list.add(user4);
    ...
    public String json4() throws JsonProcessingException {
        ...
        //  发现问题：时间默认返回的Json字符串变成了时间戳的格式1612248486605
    ...
    public String json5() throws JsonProcessingException {
        ...
        //  1、如何让他不返回时间戳，所以我们要关闭它的时间戳
        mapper.configure(SerializationFeature.WRITE_DATE_KEYS_AS_TIMESTAMPS,false); //  默认为true
        //  2、时间格式化问题 自定义日期格式对象
